...
void *AudioALSASpeechStreamController::SpeechStreamThread(void *arg)
{
    ...
    */
    ...
    {
        ALOGE("SpeechStreamThread pSphStrmCtrl = NULL arg = %x", arg);
        return 0;
    }
    ...
    */
    ...
    /*
      *  ----start the loop --------
    */
    streamInput = pSphStrmCtrl->getStreamManager()->openInputStream(Inputdevice, &Inputformat, &Inputchannel, &InputsampleRate, &status, (android_audio_legacy::AudioSystem::audio_in_acoustics)0);
