...
class AudioALSANLEController
{
    ...
    private:
        ...
        status_t getMaxSPLandZeroCnt(RingBuf* pRingBuf, size_t zuframecount, float* pSPL_Db, size_t* pZeroCnt);
...
class AudioALSANLECtrl
{
    public:
        ...
        status_t getMaxSPLandZeroCnt(NleHwInfo_t* pNleHwInfo, RingBuf* pRingBuf, size_t zuframecount, float* pSPL_Db, size_t* pZeroCnt);
