...
{
    ALOGD("+%s(), mDevice = 0x%x, sample_rate = %d, num_channels = %d", __FUNCTION__, mStreamAttributeSource->output_devices, mStreamAttributeSource->sample_rate, mStreamAttributeSource->num_channels);
