...
SpeechEnhancementController::SpeechEnhancementController()
{
    ...
    sprintf(property_default_value, "%d,%d", SPH_ENH_MAIN_MASK_ALL, (SPH_ENH_DYNAMIC_MASK_ALL & (~SPH_ENH_DYNAMIC_MASK_LSPK_DMNR) & (~SPH_ENH_DYNAMIC_MASK_SIDEKEY_DGAIN)));
#else
    sprintf(property_default_value, "%d,%d", (SPH_ENH_MAIN_MASK_ALL & (~SPH_ENH_MAIN_MASK_DMNR)), (SPH_ENH_DYNAMIC_MASK_ALL & (~SPH_ENH_DYNAMIC_MASK_DMNR) & (~SPH_ENH_DYNAMIC_MASK_LSPK_DMNR) & (~SPH_ENH_DYNAMIC_MASK_SIDEKEY_DGAIN)));
#endif
...
{
    char property_value[PROPERTY_VALUE_MAX];
    sprintf(property_value, "%d,%d", mask.main_func, mask.dynamic_func);
