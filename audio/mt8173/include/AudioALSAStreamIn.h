...
class AudioALSAStreamIn : public android_audio_legacy::AudioMTKStreamInInterface
{
    public:
        AudioALSAStreamIn();
        ...
        static size_t getInputBufferSize(uint32_t sampleRate, int format, int channelCount);
