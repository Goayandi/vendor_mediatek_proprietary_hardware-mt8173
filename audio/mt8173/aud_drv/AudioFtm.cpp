...
int AudioFtm::RecieverTest(char receiver_test)
{
    ...
    {
        AudioVolumeInterface *vol = AudioVolumeFactory::CreateAudioVolumeController();
        vol->setMasterVolume(vol->getMasterVolume(), AUDIO_MODE_NORMAL, AUDIO_DEVICE_OUT_EARPIECE);
...
int AudioFtm::LouderSPKTest(char left_channel, char right_channel)
{
    ...
    {
        AudioVolumeInterface *vol = AudioVolumeFactory::CreateAudioVolumeController();
        vol->setMasterVolume(vol->getMasterVolume(), AUDIO_MODE_NORMAL, AUDIO_DEVICE_OUT_SPEAKER);
...
int AudioFtm::EarphoneTest(char bEnable)
{
    ...
    {
        AudioVolumeInterface *vol = AudioVolumeFactory::CreateAudioVolumeController();
        vol->setMasterVolume(vol->getMasterVolume(), AUDIO_MODE_NORMAL, AUDIO_DEVICE_OUT_WIRED_HEADPHONE);
...
int AudioFtm::Audio_READ_SPK_OC_STA(void)
{
    ...
    int retval, dValue;
    ctl = mixer_get_ctl_by_name(mMixer, "Speaker_OC_Flag");
    if (NULL == ctl)
    {
...
bool AudioFtm::ReadAuxadcData(int channel __unused, int *value __unused)
{
    // not supported
    ALOGD("%s()", __FUNCTION__);
    return false;
...
status_t AudioFtm::setMicEnable(const audio_mic_mask_t audio_mic_mask, const bool enable)
{
        ...
        switch (audio_mic_mask)
        {
            case AUDIO_MIC_MASK_MIC1:
            {
                if (IsAudioSupportFeature(AUDIO_SUPPORT_DMIC)) {
                    mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_Digital_Mic_Switch"), "On");
                } else {
                    mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_ADC_1_Switch"), "On");
                    mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_ADC_2_Switch"), "On");
                    mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_Preamp1_Switch"), "AIN1");
                    mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_Preamp2_Switch"), "AIN1");
                }
                break;
            }
            case AUDIO_MIC_MASK_MIC2:
            {
                if (IsAudioSupportFeature(AUDIO_SUPPORT_DMIC)) { 
                    ...
                    mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_ADC_1_Switch"), "On");
                    mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_ADC_2_Switch"), "On");
                    mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_Preamp1_Switch"), "AIN3");
                    mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_Preamp2_Switch"), "AIN3");
                }
                break;
            }
            ...
            case AUDIO_MIC_MASK_HEADSET_MIC:
            {
                mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_ADC_1_Switch"), "On");
                mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_ADC_2_Switch"), "On");
                mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_Preamp1_Switch"), "AIN2");
                mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_Preamp2_Switch"), "AIN2");
                break;
            }
            default:
            {
    ...
    else
    {
        switch (audio_mic_mask)
        {
            ...
            {
                if (IsAudioSupportFeature(AUDIO_SUPPORT_DMIC)) {
                    mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_Digital_Mic_Switch"), "Off");
                } else {
                    mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_Preamp1_Switch"), "OPEN");
                    mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_Preamp2_Switch"), "OPEN");
                    mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_ADC_1_Switch"), "Off");
                    mixer_ctl_set_enum_by_string(mixer_get_ctl_by_name(mMixer, "Audio_ADC_2_Switch"), "Off");
                }
                break;
            }
            case AUDIO_MIC_MASK_MIC3:
