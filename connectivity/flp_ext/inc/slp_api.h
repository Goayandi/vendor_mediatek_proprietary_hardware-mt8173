...
#define SCLP_CMD_BUFF_SIZE 8192
#define SCLP_CALLBACK_BUFF_SIZE 8192
#define SCLP_CMD_SOCKET_PATH "mtk_slp_cmd_socket"
#define SCLP_CALLBACK_SOCKET_PATH "mtk_slp_callback_socket"
#define SCLP_MAX_CELL_SIZE 10//need to change to 10, temp size =5 due to omessage length restriction
...
typedef struct {
    ...
    int session_id;
    int num;
    sclp_reacquire_cell_info cells[SCLP_MAX_CELL_SIZE];
} sclp_cell_reacquire_info_list;
