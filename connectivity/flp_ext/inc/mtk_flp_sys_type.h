...
#ifndef K2_PLATFORM
typedef void FLP_VOID;
typedef signed int      FLP_INT32;
typedef signed short    FLP_INT16;
typedef signed char     FLP_INT8;
typedef unsigned int   FLP_UINT32;
typedef unsigned short FLP_UINT16;
typedef unsigned char  FLP_UINT8;
typedef unsigned char  FLP_CH;
#endif
...
typedef enum{
    ...
    MTK_FLP_MSG_SYS_,
    MTK_FLP_MSG_SYS_FLPD_REBOOT_DONE_NTF,
    MTK_FLP_MSG_SYS_MNLD_REBOOT_DONE_NTF,
    MTK_FLP_MSG_SYS_REPORT_MODE_NTF,
    MTK_FLP_MSG_SYS_REPORT_MNL_INIT_CMD,
    MTK_FLP_MSG_SYS_RECOVERY_CMD,
    MTK_FLP_MSG_SYS_CHECK_CNN_NTF,
    ...
    MTK_FLP_MSG_HAL_ACQUIRE_WAKE_LOCK_NTF = 0x20,
