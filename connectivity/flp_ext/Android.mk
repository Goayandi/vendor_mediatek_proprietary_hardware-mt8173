...
########################################
include $(CLEAR_VARS)
LOCAL_MODULE := libmtkflp_kf
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_SRC_FILES := lib/libmtkflp_kf.so
...
LOCAL_SRC_FILES :=  \
     ...
     ./src/mtk_flp_dc_gnss.c  \
     ./src/mtk_flp_dc_wifi.c  \
     ./src/mtk_flp_dc_offload.c \
     ./src/mtk_flp_dc_sensor.c \
     ./src/mtk_flp_dc_pseudo.c
...
LOCAL_SHARED_LIBRARIES += libcutils libmtkflp_kf liblog

include $(MTK_EXECUTABLE)

########################################
# Build MTK libmtkflp shared library
########################################
include $(CLEAR_VARS)
#LOCAL_PATH := $(call my-dir)
LOCAL_PRELINK_MODULE := false
