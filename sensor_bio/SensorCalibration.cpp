...
void SensorCalibration::loadSensorSettings(const char *setting_dir, sp<JSONObject>* settings,
    const char *saved_setting_dir, sp<JSONObject>* saved_settings) {
    File settings_file(setting_dir, "r");
    File saved_settings_file(saved_setting_dir, "r");
