...
/*--------------------------------------------------------*/
    ...
    #endif
    #ifndef GRV_FIFO_MAX_COUNT
        #define GRV_FIFO_MAX_COUNT        0
    #endif
    #ifndef GRV_FIFO_RESERVE_COUNT
        #define GRV_FIFO_RESERVE_COUNT      0
    #endif
#endif
    ...
    #endif
    #ifndef GMRV_FIFO_MAX_COUNT
        #define GMRV_FIFO_MAX_COUNT       0
    #endif
    #ifndef GMRV_FIFO_RESERVE_COUNT
        #define GMRV_FIFO_RESERVE_COUNT      0
    #endif
#endif
    ...
    #endif
    #ifndef RV_FIFO_MAX_COUNT
        #define RV_FIFO_MAX_COUNT         0
    #endif
    #ifndef RV_FIFO_RESERVE_COUNT
        #define RV_FIFO_RESERVE_COUNT      0
    #endif
#endif
...
struct sensor_t sSensorList[] =
{
...
#ifdef CUSTOM_KERNEL_GRV_SENSOR
    {
        ...
        .fifoReservedEventCount = GRV_FIFO_RESERVE_COUNT,
        .fifoMaxEventCount = GRV_FIFO_MAX_COUNT,
        .flags      = SENSOR_FLAG_CONTINUOUS_MODE,
        .reserved   = {}
    },
#endif
...
#ifdef CUSTOM_KERNEL_GMRV_SENSOR
    {
        ...
        .fifoReservedEventCount = GMRV_FIFO_RESERVE_COUNT,
        .fifoMaxEventCount = GMRV_FIFO_MAX_COUNT,
        .flags      = SENSOR_FLAG_CONTINUOUS_MODE,
        .reserved   = {}
    },
#endif
...
#ifdef CUSTOM_KERNEL_RV_SENSOR
    {
        ...
        .fifoReservedEventCount = RV_FIFO_RESERVE_COUNT,
        .fifoMaxEventCount = RV_FIFO_MAX_COUNT,
        .flags      = SENSOR_FLAG_CONTINUOUS_MODE,
        .reserved   = {}
    },
#endif
