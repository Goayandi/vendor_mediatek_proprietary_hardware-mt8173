...
LOCAL_SHARED_LIBRARIES := liblog libcutils libutils libstagefright_foundation
LOCAL_SRC_FILES := \
sensors.c hwmsen_chip_info.c nusensors.cpp SensorEventReader.cpp SensorBase.cpp Acceleration.cpp \
Magnetic.cpp Gyroscope.cpp AmbienteLight.cpp Proximity.cpp Pressure.cpp StepCounter.cpp \
Activity.cpp Pedometer.cpp Tilt.cpp Humidity.cpp Gesture.cpp Fusion.cpp file.cpp JSONObject.cpp \
