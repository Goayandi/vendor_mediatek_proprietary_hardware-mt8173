...
$(call HAL_INSTALL_LIB,$(1),$(2)/hwcomposer.rogue.so,hw)
endif
$(call GPU_INSTALL_FIRM,$(1),$(2)/rgx.fw.signed)
...
$(call GPU_INSTALL_LIB,$(1),$(2)/libclangIMG.so)
$(call GPU_INSTALL_LIB,$(1),$(2)/libLLVMIMG.so)
