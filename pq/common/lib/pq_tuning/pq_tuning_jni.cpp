...
static int getIndex(PQ_TuningIndex_t a_eIndex)
{
    ...
    //assume scenario is image, mode is already set in PQservice by miravision
    client.getColorIndex(&pqparam, PQClient::SCENARIO_PICTURE, PQ_PIC_MODE_STANDARD);
    client.getTDSHPIndex(&pqparam, PQClient::SCENARIO_PICTURE, PQ_PIC_MODE_STANDARD);
#endif
...
static jboolean setIndex(PQ_TuningIndex_t a_eIndex , unsigned int a_u4Index)
{
    ...
    switch(a_eIndex){
        ...
        case PQ_Sharp_Adj:
            {
                 client.setPQIndex(a_u4Index, PQClient::SCENARIO_PICTURE, TDSHP_FLAG_TUNING, SET_PQ_SHP_GAIN);
            break;
            }
        case PQ_Sat_Adj:
            {
                 client.setPQIndex(a_u4Index, PQClient::SCENARIO_PICTURE, TDSHP_FLAG_TUNING, SET_PQ_SAT_GAIN);
            break;
            }
        case PQ_SkinTone_H:
            {
                 client.setPQIndex(a_u4Index, PQClient::SCENARIO_PICTURE, TDSHP_FLAG_TUNING, SET_PQ_HUE_ADJ_SKIN);
            break;
            }
        case PQ_GrassTone_H:
            {
                 client.setPQIndex(a_u4Index, PQClient::SCENARIO_PICTURE, TDSHP_FLAG_TUNING, SET_PQ_HUE_ADJ_GRASS);
            break;
            }
        case PQ_SkyTone_H:
            {
                 client.setPQIndex(a_u4Index, PQClient::SCENARIO_PICTURE, TDSHP_FLAG_TUNING, SET_PQ_HUE_ADJ_SKY);
            break;
            }
        case PQ_SkinTone_S:
            {
                 client.setPQIndex(a_u4Index, PQClient::SCENARIO_PICTURE, TDSHP_FLAG_TUNING, SET_PQ_SAT_ADJ_SKIN);
            break;
            }
        case PQ_GrassTone_S:
            {
                 client.setPQIndex(a_u4Index, PQClient::SCENARIO_PICTURE, TDSHP_FLAG_TUNING, SET_PQ_SAT_ADJ_GRASS);
            break;
            }
        case PQ_SkyTone_S:
            {
                 client.setPQIndex(a_u4Index, PQClient::SCENARIO_PICTURE, TDSHP_FLAG_TUNING, SET_PQ_SAT_ADJ_SKY);
            break;
            }
