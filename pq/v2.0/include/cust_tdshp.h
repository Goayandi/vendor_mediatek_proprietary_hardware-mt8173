...
#define GLOBAL_PQ_VIDEO_SHARPNESS_STRENGTH_RANGE 10
#define GLOBAL_PQ_VIDEO_DC_STRENGTH_RANGE 10
#define GLOBAL_PQ_UI_SHARPNESS_STRENGTH_RANGE 10
#define GLOBAL_PQ_UI_DC_STRENGTH_RANGE 10

#define GLOBAL_PQ_DC_INDEX_MAX 11

typedef struct{
    unsigned int entry[GLOBAL_PQ_DC_INDEX_MAX][40];
} DISPLAY_DC_T;
