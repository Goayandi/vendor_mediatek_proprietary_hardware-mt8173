...
static int getIndex(PQ_DC_index_t a_eIndex)
{
    ...
    client.setTuningField(IPQService::MOD_DC_SWREG, 0xffff, PROXY_TUNING_READING);
    int value;
    client.getTuningField(IPQService::MOD_DC_SWREG, getPQDCOffset(a_eIndex), &value);
...
static jboolean setIndex(PQ_DC_index_t a_eIndex , unsigned int a_u4Index)
{
    ...
    client.setTuningField(IPQService::MOD_DC_SWREG, 0xffff, PROXY_TUNING_OVERWRITTEN);
    client.setTuningField(IPQService::MOD_DC_SWREG, getPQDCOffset(a_eIndex), a_u4Index);
    client.setTuningField(IPQService::MOD_DC_SWREG, 0xfffe, 0);
...
static jboolean setTuningMode(JNIEnv *env, jobject thiz, int mode)
{
    ...
    {
        client.setTuningField(IPQService::MOD_DC_SWREG, 0xffff, PROXY_TUNING_NORMAL);
    }
