...
int main(int argc, char **argv) {
    ...
    if (rilLibPath == NULL) {
#ifdef MTK_RIL_MD2
        if ( 0 == property_get(LIB_PATH_PROPERTY, libPath, "mtk-rilmd2.so")) {
#else
...
#ifdef MTK_RIL_MD2
#define  REFERENCE_RIL_PATH  "mtk-rilmd2.so"
#else
#define  REFERENCE_RIL_PATH  "mtk-ril.so"
#endif
