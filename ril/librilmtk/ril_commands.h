...
*/
    ...
    {RIL_REQUEST_SEND_USSD, dispatchString, responseVoid, RIL_CMD_PROXY_2},
    ...
    {RIL_REQUEST_IMS_SEND_SMS, dispatchImsSms, responseSMS, RIL_CMD_PROXY_1},
    ...
    {RIL_REQUEST_NV_WRITE_CDMA_PRL, dispatchRaw, responseVoid, RIL_CMD_PROXY_3},
    {RIL_REQUEST_NV_RESET_CONFIG, dispatchInts, responseVoid, RIL_CMD_PROXY_3},
    {RIL_REQUEST_SET_UICC_SUBSCRIPTION, dispatchUiccSubscripton, responseVoid, RIL_CMD_PROXY_1},
    {RIL_REQUEST_ALLOW_DATA, dispatchInts, responseVoid, RIL_CMD_PROXY_5},
    {RIL_REQUEST_GET_HARDWARE_CONFIG, dispatchVoid, responseVoid, RIL_CMD_PROXY_3},
    {RIL_REQUEST_SIM_AUTHENTICATION, dispatchSimAuthentication, responseSIM_IO, RIL_CMD_PROXY_1},
    ...
    {RIL_REQUEST_SHUTDOWN, dispatchVoid, responseVoid, RIL_CMD_PROXY_1},
    {RIL_REQUEST_GET_RADIO_CAPABILITY, dispatchVoid, responseRadioCapability, RIL_CMD_PROXY_2},
    {RIL_REQUEST_SET_RADIO_CAPABILITY, dispatchRadioCapability, responseRadioCapability, RIL_CMD_PROXY_2},
    {RIL_REQUEST_START_LCE, dispatchInts, responseLceStatus, RIL_CMD_PROXY_5},
    {RIL_REQUEST_STOP_LCE, dispatchVoid, responseLceStatus, RIL_CMD_PROXY_5},
    {RIL_REQUEST_PULL_LCEDATA, dispatchVoid, responseLceData, RIL_CMD_PROXY_5},
