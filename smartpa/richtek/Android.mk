...
LOCAL_SRC_FILES := rt_extamp_intf.c
...
LOCAL_SRC_FILES := rt_extamp_test.c

LOCAL_MODULE := rt_extamp_test
LOCAL_SHARED_LIBRARIES := libcutils libutils librt_extamp_intf
