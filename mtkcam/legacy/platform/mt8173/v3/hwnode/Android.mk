...
$(warning "zcj MTK_ALPS_BOX_SUPPORT no")
...
# enable dngop or not
#LOCAL_CFLAGS += -DMTK_TEMP_DNGOP_ENABLE=0
#
...
# RAW16
# temp comment libdnpop, because protect code not ready
ifeq ($(MTK_TEMP_DNGOP_ENABLE),1)
$(warning "Will use shared library: libdngop")
LOCAL_SHARED_LIBRARIES += libdngop
else
$(warning "Will not use shared library: libdngop")
endif
# irq
LOCAL_SHARED_LIBRARIES += libcamdrv
# sensor
