...
getBufStridesInBytes(i));
                ...
                String8 filename = String8::format("%s%s_%dx%d_%u.yuv",
                        DUMP_PATH,
                        portName.string(), pImgBuf->getImgSize().w, pImgBuf->
getImgSize().w,
                        cnt);
                pImgBuf->saveToFile(filename.string());
            }
        ...
        {
            debug::dumpImg(String8::format("dst_%d", i), vDst[i], muCnt);
        }
    }
    //
    muCnt++;
