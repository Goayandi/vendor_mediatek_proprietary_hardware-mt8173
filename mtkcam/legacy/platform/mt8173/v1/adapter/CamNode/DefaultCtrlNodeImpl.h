                                 ...
                                 , public I3ACallBack
{
    ...
    public: // ctor & dtor
        ...
        static MVOID *stopSmoothZoomThreadFunc(MVOID *arg);
    ...
    public: // operations
        ...
        ICallBackZoom*getCallbackZoom()
        {
            return mpCallbackZoom;
        }

        IspSyncControl*getIspSyncCtrl()        
        {
            return mpIspSyncCtrl;
        }
    //
    protected:
