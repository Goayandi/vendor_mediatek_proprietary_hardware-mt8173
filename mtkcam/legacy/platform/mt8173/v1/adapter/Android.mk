...
$(warning "MTKCAM_BASIC_PACKAGE:$(MTKCAM_BASIC_PACKAGE)")
ifneq ($(MTKCAM_BASIC_PACKAGE), 1)
$(warning "will use libcam.utils.cpuctrl")
LOCAL_SHARED_LIBRARIES += libcam.utils.cpuctrl
else
$(warning "will not use libcam.utils.cpuctrl")
endif
#
