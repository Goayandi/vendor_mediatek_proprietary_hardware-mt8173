...
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_HDR_EFFECT_HAL_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_HDR_EFFECT_HAL_H_
 ...
 ******************************************************************************/
namespace NSCam {
class HdrEffectHal : public EffectHalBase
{
public:
                                HdrEffectHal() {}
    virtual                     ~HdrEffectHal() {}
...
//    virtual android::status_t   getCaptureRequirementImpl(EffectCaptureRequirement  & requirement) const;
    ...
    //non-blocking
    virtual android::status_t   addInputFrameImpl(const android::sp<IImageBuffer> frame, const android::sp<EffectParameter> parameter=NULL);
    //non-blocking
    virtual android::status_t   addOutputFrameImpl(const android::sp<IImageBuffer> frame, const android::sp<EffectParameter> parameter=NULL);
...
private:
    ...
    IHdrProc*       mpHdrProc;
    MUINT32        mu4FrameNum;
    BasicParameters mHdrEffectHalParam;
    android::String8 mSupportedParameters;
};

}   //namespace NSCam {

#endif  //_MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_HDR_EFFECT_HAL_H_
