    ...
    for(i=0; i<u4AreaCnt; i++) {
        ...
        if((m_eZoomWinInfo.u4XOffset != 0) && (m_eZoomWinInfo.u4YOffset != 0)){
            if ( (m_eAEMeterArea.rAreas[i].i4Left != 0)||(m_eAEMeterArea.rAreas[i].i4Right != 0)||(m_eAEMeterArea.rAreas[i].i4Top != 0)||(m_eAEMeterArea.rAreas[i].i4Bottom != 0) ){
              m_eAEMeterArea.rAreas[i].i4Left   = -1000 + (m_eZoomWinInfo.u4XOffset-m_rAEInitInput.rEZoomWin.u4XOffset)*2000/m_rAEInitInput.rEZoomWin.u4XWidth  + (sAEMeteringArea->rAreas[i].i4Left + 1000)*m_eZoomWinInfo.u4XWidth/m_rAEInitInput.rEZoomWin.u4XWidth;
              m_eAEMeterArea.rAreas[i].i4Right  = -1000 + (m_eZoomWinInfo.u4XOffset-m_rAEInitInput.rEZoomWin.u4XOffset)*2000/m_rAEInitInput.rEZoomWin.u4XWidth  + (sAEMeteringArea->rAreas[i].i4Right+ 1000)*m_eZoomWinInfo.u4XWidth/m_rAEInitInput.rEZoomWin.u4XWidth;
              m_eAEMeterArea.rAreas[i].i4Top    = -1000 + (m_eZoomWinInfo.u4YOffset-m_rAEInitInput.rEZoomWin.u4YOffset)*2000/m_rAEInitInput.rEZoomWin.u4YHeight + (sAEMeteringArea->rAreas[i].i4Top+ 1000)*m_eZoomWinInfo.u4YHeight/m_rAEInitInput.rEZoomWin.u4YHeight;
              m_eAEMeterArea.rAreas[i].i4Bottom = -1000 + (m_eZoomWinInfo.u4YOffset-m_rAEInitInput.rEZoomWin.u4YOffset)*2000/m_rAEInitInput.rEZoomWin.u4YHeight + (sAEMeteringArea->rAreas[i].i4Bottom+ 1000)*m_eZoomWinInfo.u4YHeight/m_rAEInitInput.rEZoomWin.u4YHeight;
            }
...
#if MTKCAM_TEMP_AEMGR_AEALGO_CALL_INITAE 
#warning "MTKCAM_TEMP_AEMGR_AEALGO_CALL_INITAE is 1"
    m_pIAeAlgo->initAE(&m_rAEInitInput, &rAEOutput, &m_rAEStatCfg);
#else
#warning "MTKCAM_TEMP_AEMGR_AEALGO_CALL_INITAE is 0"
