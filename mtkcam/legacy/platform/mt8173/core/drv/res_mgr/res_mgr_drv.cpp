...
queryCtrlType()
{
    ...
    #endif
    MY_LOGD("step(%d),profileType(%d),sensorSize(%d),sensorFps(%d),bPip(%d),bVfb(%d),bEis20(%d),bIvhdr(%d)",
            mBwcParams.step,
            mBwcParams.profileType,
            mBwcParams.sensorSize,
            mBwcParams.sensorFps,
...
triggerCtrl()
{
    ...
    //
    MY_LOGD("profileType(%d),sensorSize(%d),sensorFps(%d),bPip(%d),bVfb(%d),bEis20(%d),bIvhdr(%d)",
            mBwcParams.profileType,
            mBwcParams.sensorSize,
            mBwcParams.sensorFps,
            mBwcParams.bPip,
