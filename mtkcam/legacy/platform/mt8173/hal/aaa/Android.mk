...
# don't include platform mtkcam.mk immediately after $(MTK_PATH_SOURCE)/hardware/mtkcam/mtkcam.mk now, or build error will occur
...
ifeq ($(MTKCAM_TEMP_ENABLE_FAKE_LIB3A),1)
LOCAL_CFLAGS += -DFAKE_LIB3A=1
else
LOCAL_CFLAGS += -DFAKE_LIB3A=0
endif
