...
#for build pass
ifeq ($(strip $(TARGET_BOARD_PLATFORM)),$(filter $(TARGET_BOARD_PLATFORM),elbrus mt6799))
...
LOCAL_C_INCLUDES += $(META_DRIVER_PATH)/cameratool/$(shell echo $(MTK_PLATFORM) | tr A-Z a-z)/D2/CCAP\
                    ...
                    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/platform/mt6735m/inc/acdk \
                    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/platform/mt6735m/include \
                    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/platform/mt6735m/acdk/inc/cct\
...
else ifeq ($(strip $(TARGET_BOARD_PLATFORM)),$(filter $(TARGET_BOARD_PLATFORM),mt6735 mt6737t mt6753))
LOCAL_C_INCLUDES += $(META_DRIVER_PATH)/cameratool/$(shell echo $(MTK_PLATFORM) | tr A-Z a-z)/D1/CCAP \
                    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/inc/acdk \
                    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/platform/mt6735/inc/acdk \
                    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/platform/mt6735/acdk/inc/cct\
                    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/platform/mt6735 \
                    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/platform/mt6735/include \
                    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/include \
                    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/include/mtkcam \
                    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/include\
                    $(TOP)/$(MTK_PATH_COMMON)/kernel/imgsensor/inc \
...
else ifeq ($(strip $(TARGET_BOARD_PLATFORM)),$(filter $(TARGET_BOARD_PLATFORM),mt6797 mt6757 kiboplus mt6799))
...
LOCAL_CFLAGS += -DMTK_MDDB_PATH=\"/$(TARGET_COPY_OUT_VENDOR)/etc/mddb\"
