        ...
        if (meta_bt_get_combo_id(&chipId) < 0) {
            ...
            switch (chipId) {
              ...
              case 0x6630:
                ...
                break;
              case 0x6632:
                bt_cnf.result.dummy = BT_CHIP_ID_MT6632;
                break;
              case 0x6582:
              ...
              case 0x6755:
                ...
                break;
              case 0x6797:
                bt_cnf.result.dummy = BT_CHIP_ID_MT6797;
                break;
              case 0x6757:
                bt_cnf.result.dummy = BT_CHIP_ID_MT6757;
                break;
              case 0x8163:
                bt_cnf.result.dummy = BT_CHIP_ID_MT8163;
                break;
              case 0x8127:
                bt_cnf.result.dummy = BT_CHIP_ID_MT8127;
                break;
              default:
